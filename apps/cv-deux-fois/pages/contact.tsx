...
export default function Contact() {
    ...
    return (
        <div id='contact' style={{marginTop: '0px', paddingBottom:'200px', paddingTop:'00px', width:'100vw'}}>
            ...
            <form className='flex-column flex-center form' onSubmit={onSubmit} style={{marginTop: '50px'}}>
