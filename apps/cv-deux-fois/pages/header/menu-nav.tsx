...
export default function MenuNav() {
    ...
    <nav>
        <ul className='flex ' id='nav-links'>
                <li>
                <Link href="#home" as="">
                <div id="navhome" className='link active'>
                ...
                <div id="navportfolio" className='link'>
